...
public class TGCSSounds {
    ...
    public static final ResourceKey<JukeboxSong> MUSIC_DISC_DEATHODYSSEY_KEY = createSong("deathodyssey");
    public static final ResourceKey<JukeboxSong> MUSIC_DISC_DAUGHTEROFHALLOWNEST_KEY = createSong("daughterofhallownest");
    public static final ResourceKey<JukeboxSong> MUSIC_DISC_REMEMBER_KEY = createSong("remember");
