...
import com.itred.tgcshenanigans.config.ConfiguredEventManager;
...
public class ThisGCsShenanigans {
    ...
    @Nullable
    public static ConfiguredEventManager CONFIG_MANAGER;
    ...
    public ThisGCsShenanigans(IEventBus modEventBus, ModContainer modContainer) {
        ...
        CONFIG_MANAGER = new ConfiguredEventManager(modEventBus);
